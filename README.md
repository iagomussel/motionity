# Motionity (Forked, evolving)

![Preview](preview.gif)<br><br>
The web-based motion graphics editor for everyone 📽

This repository is a fork of Motionity and is now evolving into a new, separate software project. It started from the original Motionity codebase and will continue to diverge with its own roadmap and features.

Motionity is a free and open source animation editor on the web. It's a mix of After Effects and Canva, with powerful features like keyframing, masking, filters, and more, and integrations to browse for assets to easily drag and drop into your video.
...
> You can support the original Motionity project (and many others) through [GitHub Sponsors](https://github.com/sponsors/alyssaxuu)! ❤️

Original Motionity created by [Alyssa X](https://twitter.com/alyssaxuu). This fork is maintained separately.
